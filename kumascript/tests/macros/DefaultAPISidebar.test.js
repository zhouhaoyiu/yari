...
const expectedTargets = {
  ...
  "A Guide which is also a subpage":
    "/docs/Web/API/TestInterface_API/MyGuidePage1",
  // interfaces
  ...
  "ADifferentInterface.doSomething()":
    "/docs/Web/API/ADifferentInterface/doSomething",
  "YetAnotherInterface.doSomething()":
    "/docs/Web/API/YetAnotherInterface/doSomething",
  // properties
  "ADifferentInterface.aProperty":
    "/docs/Web/API/ADifferentInterface/aProperty",
  "ADifferentInterface.anotherProperty":
    "/docs/Web/API/ADifferentInterface/anotherProperty",
  // events
